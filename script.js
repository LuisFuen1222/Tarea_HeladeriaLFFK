...
for (let i = 0; i < 3; i++) {
  if (money[i] > 49) {
    com = prompt(
      `El dinero con el que cuenta ${nombre[i]} es  ${money[i]}, Una disculpa, pero solo contamos con el siguiente producto: \n 1.  ${producto[5]} $ ${precio[5]}  \n Elige tu helado!`
    );
    if (com == 1) {
...
document.getElementById("Luis").innerHTML = money[0];
document.getElementById("Bianka").innerHTML = money[1];
document.getElementById("Valeska").innerHTML = money[2];
